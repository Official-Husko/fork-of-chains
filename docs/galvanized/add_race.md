<!-- File Version: 2.0 | Last Updated: 2025-08-12 -->

# How to Add a New Subrace to Fort of Chains: Galvanized

This guide explains the full process for adding a new subrace (not a main race that can host subraces), including lore, region, traits, and body part (skin) entries. All races added with this process are subraces and should be linked to a parent/main race.
...
## 3. Select a Region for Your Race
