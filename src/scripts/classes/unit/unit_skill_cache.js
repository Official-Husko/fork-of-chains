...
setup.Unit.prototype.getSkills = function (is_base_only) {
    return getOrCreateCachedValue(this, is_base_only ? 'unitskillsbaseonly' : 'unitskills', () => computeSkills(this, is_base_only));
};
setup.Unit.prototype.getSkillsAdd = function (is_base_only) {
    return getOrCreateCachedValue(this, is_base_only ? 'unitskilladdsbaseonly' : 'unitskilladds', () => computeSkillsAdd(this, is_base_only));
};
setup.Unit.prototype.getSkillModifiers = function (is_base_only) {
    return getOrCreateCachedValue(this, is_base_only ? 'unitskillmodifiersbaseonly' : 'unitskillmodifiers', () => computeSkillModifiers(this, is_base_only));
};
setup.Unit.prototype.getSkillsBase = function (ignore_skill_boost) {
    return getOrCreateCachedValue(this, ignore_skill_boost ? 'unitskillsbaseignoreskillboost' : 'unitskillsbase', () => computeSkillsBase(this, ignore_skill_boost));
};
setup.Unit.prototype.getSkillAdditives = function (is_base_only) {
    return getOrCreateCachedValue(this, is_base_only ? 'unitskilladditivesbaseonly' : 'unitskilladditives', () => computeSkillAdditives(this, is_base_only));
};
