...
setup.DOM.Card.equipment = function (equipment, hide_actions) {
    const fragments = [];
    fragments.push(setup.DOM.Util.menuItemToolbar(equipmentNameActionMenu(equipment, hide_actions)));
...
setup.DOM.Card.equipmentcompact = function (equipment, hide_actions) {
    return setup.DOM.Util.menuItemToolbar(equipmentNameActionMenu(equipment, hide_actions));
};
