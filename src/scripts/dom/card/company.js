...
function companyIreFragment(company) {
  ...
  `);
    return setup.DOM.create('span', {
        'data-tooltip': "This represents how annoyed certain members of this company is against your company. " +
...
function companyFavorDecayInfoFragment(company) {
    ...
    ${decay ? setup.DOM.create('span', {
        'data-tooltip': "Favor will tend to decay over time. This can be mitigated " +
...
setup.DOM.Card.company = function (company, hide_actions) {
    const fragments = [];
    fragments.push(html `
${setup.DOM.Util.menuItemToolbar(companyNameActionMenu(company, hide_actions))}
<div>
...
setup.DOM.Card.companycompact = function (company, hide_actions) {
    return setup.DOM.Util.menuItemToolbar(companyNameActionMenu(company, hide_actions));
};
