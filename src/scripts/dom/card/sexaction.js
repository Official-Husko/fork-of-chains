// @ts-nocheck
import { menuItemAction, menuItemExtras, menuItemTitle } from "../../ui/menu";
/**
...
setup.DOM.Card.sexaction = function (action, hide_actions) {
    const fragments = [];
    // title stuffs
    fragments.push(setup.DOM.Util.menuItemToolbar(sexActionNameActionMenu(action, hide_actions)));
